...
const Infoprofile = () => {
    ...
    const userUploadedContents = allContents.filter(item => item.uploaded_by?._id === userId);
    ...
    const totalApproved = userUploadedContents.filter(item => item.isApproved === "approved").length;
