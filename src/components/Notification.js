...
const Notification = () => {
  ...
  return (
    <>
      <div onClick={handleViewPopup} className={`cursor-pointer button-big ${darkMode ? 'bg-zinc-800 text-zinc-300' : 'bg-slate-100 text-black'}`}>
        <IconBell stroke={2} />
      </div>

      {showPopup && (
        <div className="flex bottom-0 z-[999] fixed top-[9%] right-[20px] w-[447px]">
