...
const Login = () => {
  ...
  const handleSubmit = async () => {
    if (!emailOrMobile || !password) {
      dispatch(showNotification('Email or Mobile and Password are required.', 'error'));
      return;
    }
    ...
    try {
      ...
      if (response.success) {
        ...
        dispatch(showNotification('Login failed. Please check your credentials.', 'error'));
      }
    } catch (error) {
      dispatch(showNotification('Error during login. Please try again.', 'error'));
    }
  };
...
>        <div className='rounded-2xl h-full w-full flex overflow-hidden'>
    ...
    backgroundPosition: 'center center',
            ...
            <>
              <div className='pb-12 text-3xl flex flex-col justify-center items-center gap-3'>
