        ...
        return (
          <div>
            <Space>
              ...
              {/* MODULE LEVEL APPROVAL/REJECTION - Hidden for Partners */}
              {record.entryType === "module" &&
                !userRoles.some((role) => role.toLowerCase() === "partner") && (
                  <>
              ...
              {/* LEARNING VIDEO LEVEL APPROVAL/REJECTION - Hidden for Partners */}
              {(record.entryType === "learningVideo" ||
                record.individualVideoTitle) &&
                !userRoles.some((role) => role.toLowerCase() === "partner") && (
                  <>
              ...
              {/* CHALLENGE/EVENT APPROVAL/REJECTION - Hidden for Partners */}
              ...
              {/* Delete Button (only for non-Admin and non-Partner users) - For non-video content */}
