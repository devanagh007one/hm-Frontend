...
const ContentManagement = () => {
    ...
    const filteredData = useMemo(() => {
        ...
        if (filter === "active") {
            filteredCombinedData = filteredCombinedData.filter((data) => data.isApproved === "approved");
        } else if (filter === "inactive") {
            filteredCombinedData = filteredCombinedData.filter((data) => data.isApproved === "pending");
