...
const ParentComponent = ({ data }) => {
    ...
    useEffect(() => {
        if (data) {
            setFormData({
                ...
                notificationSettings: data.notificationSettings || { setupReminder: false, reminders: [] },
                notificationContent: data.notificationContent || "",
                engagementTools: data.engagementTools || { qnaSection: false, newsFeedConnection: false },
    ...
    const addOrUpdateQandA = () => {
        ...
        setFullQanda((prev) => {
            const updatedQnaList = editingIndex !== null
                ? prev.qnaList.map((qna, i) => i === editingIndex ? currentQna : qna)
    ...
    return (
        <>
            <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" className=" cursor-pointer" onClick={handleViewPopup}>
                <path opacity="0.16" d="M4.66659 13.3333L3.83325 16.6667L7.16659 15.8333L15.4999 7.5L12.9999 5L4.66659 13.3333Z" fill="#C7C7C7" />
                <path d="M12.9999 5.00007L15.4999 7.50007M11.3333 16.6667H17.9999M4.66659 13.3334L3.83325 16.6667L7.16659 15.8334L16.8216 6.17841C17.134 5.86586 17.3096 5.44201 17.3096 5.00007C17.3096 4.55813 17.134 4.13429 16.8216 3.82174L16.6783 3.67841C16.3657 3.36596 15.9419 3.19043 15.4999 3.19043C15.058 3.19043 14.6341 3.36596 14.3216 3.67841L4.66659 13.3334Z" stroke="#C7C7C7" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
                    ...
                    <div className="p-8 bg-[rgb(30,30,30)] rounded-3xl w-[509px] h-[700px] overflow-y-auto my-event">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                {formData?.questionandanswer?.[0]?.qnaList?.map((qna, index) => (
