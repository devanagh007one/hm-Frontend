...
import AssignTeamModal from "../AssignTeamModel/AssignTeamModel.js";
...
const UserManagement = () => {
  ...
  const [assignTeamModal, setAssignTeamModal] = useState({
    open: false,
    userId: null,
  });
  ...
  const filteredData = useMemo(() => {
    ...
    const sorters = {
      ...
      endDate: (a, b) =>
        new Date(a.editLogs?.slice(-1)[0]?.date || 0) -
        new Date(b.editLogs?.slice(-1)[0]?.date || 0),
  ...
  const columns = [
    ...
    },
    {
      title: (
        <div className="flex items-center">
          <SvgIcon
            onClick={() => setFilter((prev) => (prev === "Org" ? "" : "Org"))}
          />
    ...
    },
    {
      title: (
        <div className="flex items-center">
          <SvgIcon
            onClick={() =>
              setFilter((prev) => (prev === "Uploaded" ? "" : "Uploaded"))
            }
          />
          <span style={{ color: "#F48567", marginLeft: "8px" }}>
            Uploaded By
      ...
      render: (text, record) => {
        ...
        const role =
          uploadedBy.roles && uploadedBy.roles.length > 0
            ? uploadedBy.roles[0]
            : ""; // Safely access roles
    ...
    },
    {
      title: (
        <div className="flex items-center">
          <SvgIcon
            onClick={() =>
              setFilter((prev) => (prev === "endDate" ? "" : "endDate"))
            }
          />
          <span style={{ color: "#F48567", marginLeft: "8px" }}>
            Last Updated
      ...
      render: (editLogs) => {
        ...
        const formattedDate = new Date(lastLog.date).toLocaleDateString(
          "en-US",
          {
            year: "numeric",
            month: "short",
          ...
          <Space>
            <span>
              ...
              >
                ...
                />
                <path
                  d="M12.5 11.875L10 14.375L7.5 11.875M10 13.5113V8.75"
                  stroke="#C7C7C7"
                  stroke-width="1.25"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <span>
              ...
              >
                ...
                >
                  <path
                    d="M15 15.2653L12.2821 17.9747L11.5128 17.2055L12.906 15.8123H7.65812V14.7183H12.906L11.5128 13.3252L12.2821 12.5559L15 15.2653ZM9.66667 16.9064L10.7607 18.0004H0V2.68413H4.37607C4.37607 2.38213 4.43305 2.10008 4.54701 1.83797C4.66097 1.57587 4.81766 1.34225 5.01709 1.13712C5.21652 0.931991 5.44729 0.775296 5.7094 0.667034C5.97151 0.558772 6.25641 0.501792 6.5641 0.496094C6.8661 0.496094 7.14815 0.553074 7.41026 0.667034C7.67236 0.780994 7.90598 0.937689 8.11111 1.13712C8.31624 1.33655 8.47293 1.56732 8.5812 1.82943C8.68946 2.09154 8.74644 2.37644 8.75214 2.68413H13.1282V11.8551L12.0342 10.7611V3.77815H10.9402V5.96618H2.18803V3.77815H1.09402V16.9064H9.66667ZM3.28205 3.77815V4.87216H9.84615V3.77815H7.65812V2.68413C7.65812 2.53028 7.62963 2.38783 7.57265 2.25678C7.51567 2.12572 7.43875 2.01176 7.34188 1.9149C7.24501 1.81803 7.1282 1.73826 6.99145 1.67558C6.8547 1.6129 6.71225 1.58441 6.5641 1.59011C6.41026 1.59011 6.26781 1.6186 6.13675 1.67558C6.0057 1.73256 5.89174 1.80948 5.79487 1.90635C5.69801 2.00322 5.61823 2.12003 5.55556 2.25678C5.49288 2.39353 5.46439 2.53598 5.47009 2.68413V3.77815H3.28205Z"
                    fill="#C7C7C7"
                  />
                </svg>
              </span>
  ...
  return (
    <>
      ...
      <div className="flex flex-col  p-5  thescreanhe">
        ...
        >
          ...
          <div className="flex gap-7">
            ...
            <div
              className={`text-[#F48567] gap-1 flex  bg-transparent hover:bg-transparent hover:text-[#F48567] rounded ${
                darkMode ? "#F48567" : "#F48567"
              }`}
            >
              {showSearchInput && (
                <input
              ...
              <Button
                className={`text-[#F48567] border-none bg-transparent hover:bg-transparent hover:text-[#F48567] p-2 rounded ${
                  darkMode ? "#F48567" : "#F48567"
                }`}
                icon={
                  <svg
                  ...
                  >
                    <g filter="url(#filter0_b_3004_2000)">
                      ...
                      />
                      <path
                        d="M29.1163 29.65L32.9663 33.5M31.8551 22.9763C31.8551 28.21 27.6263 32.4525 22.4113 32.4525C17.1951 32.4525 12.9663 28.21 12.9663 22.9775C12.9663 17.7412 17.1951 13.5 22.4101 13.5C27.6263 13.5 31.8551 17.7425 31.8551 22.9763Z"
                        stroke="#F48567"
                        stroke-width="1.25"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feComposite
                          in2="SourceAlpha"
                          operator="in"
                          result="effect1_backgroundBlur_3004_2000"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_backgroundBlur_3004_2000"
                          result="shape"
                        />
                      </filter>
                    </defs>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_3001_972"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_backgroundBlur_3001_972"
                        result="shape"
                      />
                    </filter>
                  </defs>
                ...
                icon={
                  ...
                  >
                    <g filter="url(#filter0_b_3004_2007)">
                      ...
                      />
                      <path
                        d="M23 28.5L16.75 22.25L18.5 20.4375L21.75 23.6875V13.5H24.25V23.6875L27.5 20.4375L29.25 22.25L23 28.5ZM15.5 33.5C14.8125 33.5 14.2242 33.2554 13.735 32.7663C13.2458 32.2771 13.0008 31.6883 13 31V27.25H15.5V31H30.5V27.25H33V31C33 31.6875 32.7554 32.2763 32.2663 32.7663C31.7771 33.2563 31.1883 33.5008 30.5 33.5H15.5Z"
                        fill="#F48567"
                      />
                    </g>
                    <defs>
                      <filter
                        id="filter0_b_3004_2007"
                        x="-4"
                        y="-3.5"
                        width="54"
                        height="54"
                      ...
                      >
                        ...
                        <feComposite
                          in2="SourceAlpha"
                          operator="in"
                          result="effect1_backgroundBlur_3004_2007"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_backgroundBlur_3004_2007"
                          result="shape"
                        />
                      </filter>
                    </defs>
      ...
      <AssignTeamModal
        showModal={assignTeamModal.open}
        setShowModal={(open) =>
