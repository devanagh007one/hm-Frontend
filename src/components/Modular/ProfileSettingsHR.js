...
const Profilecreads = () => {
    ...
    const toggleEdit = () => {
        ...
        dispatch(showNotification(allEditable ? "Now you can edit all fields" : "Editing disabled", 'success'));
    };
    ...
    return (
        <>
            <div className='flex ml-3'>
                <div
                    className={`theprofilesect cursor-pointer ${showLicence ? "bg-[#333333] text-[#F48567]" : "bg-transparent"}`}
                    onClick={openLicencePopup}
                >
                    Company Profile
                </div>
                <div
                    className={`theprofilesect cursor-pointer ${showProfile ? "bg-[#333333] text-[#F48567]" : "bg-transparent"}`}
                    ...
                    <div className={`flex w-full mr-3  justify-between items-center ${darkMode ? 'text-white' : 'text-black'}`}>
                        <section className='w-full flex-col flex items-center justify-center'>
                            <div className='flex items-center justify-center'>
                                <img
                                    src={`${process.env.REACT_APP_STATIC_API_URL}/${hrlicensing?.licenseDetails?.logo?.replace('/root', '') || 'default.png'}`}
                            ...
                            <div className='flex '> <div className='mt-3 ml-5'>
                                <h3 className='text-xl'>Mr {hrlicensing?.licenseDetails?.organisationName}</h3>
                                <span className={`flex text-xs`}>{hrlicensing?.licenseDetails?.contactPersonEmail}</span>
                            </div>
                        ...
                        <section className='w-full flex-col flex items-center justify-center h-[100vh] mt-[300px]'>
                                ...
                                <button onClick={toggleEdit} className="ml-2 text-blue-500">
                                    {allFieldsTrue ? (
                                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.345 14.2167L13.7967 5.76506L12.6183 4.58672L4.16667 13.0384V14.2167H5.345ZM6.03583 15.8834H2.5V12.3476L12.0292 2.81839C12.1854 2.66216 12.3974 2.5744 12.6183 2.5744C12.8393 2.5744 13.0512 2.66216 13.2075 2.81839L15.565 5.17589C15.7212 5.33216 15.809 5.54409 15.809 5.76506C15.809 5.98603 15.7212 6.19795 15.565 6.35422L6.03583 15.8834ZM2.5 17.5501H17.5V19.2167H2.5V17.5501Z" fill="#1E1E1E" />
                                        </svg>
                                    ) : (
                                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.345 14.2167L13.7967 5.76506L12.6183 4.58672L4.16667 13.0384V14.2167H5.345ZM6.03583 15.8834H2.5V12.3476L12.0292 2.81839C12.1854 2.66216 12.3974 2.5744 12.6183 2.5744C12.8393 2.5744 13.0512 2.66216 13.2075 2.81839L15.565 5.17589C15.7212 5.33216 15.809 5.54409 15.809 5.76506C15.809 5.98603 15.7212 6.19795 15.565 6.35422L6.03583 15.8834ZM2.5 17.5501H17.5V19.2167H2.5V17.5501Z" fill="#1E1E1E" />
                                ...
                                <div className={`mt-5 w-full flex gap-7 ${darkMode ? 'text-gray-300' : 'text-black'}`}>
                                    <div className='w-full flex flex-col gap-2'>
                                        ...
                                        <EditableField
                                            ...
                                            onEditClick={() => toggleEdit('joinedAt')}
                                        />
                                        <EditableField
                                            label="Email Address"
                                        ...
                                        <EditableField
                                            ...
                                            onChange={(val) => handleChange("relationShipStatus", val)}
                            ...
                            {allFieldsTrue && (
                                <div className="flex gap-5 mt-5 w-full items-center justify-center ">
                                    <button className="w-28 p-3 rounded-2xl bg-[#F48567] text-white text-lg" onClick={handleSave}>Save</button>
                                    <button className="w-28 p-3 rounded-2xl bg-[#C7C7C7] text-white text-lg" onClick={handleCancel}>Cancel</button>
                                </div>
                            )}
                        </section>
                    </div>
