...
const EyeForm = ({ data }) => {
  ...
  const handleSave = () => {
    ...
    localStorage.setItem("activeComponent", "UsersmanagementHR"); // Store Licensing before reload
    ...
    <>
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div
            className={`rounded-3xl shadow-lg w-] max-w-[70%] overflow-y-scroll pl-10 pr-10 p-4 relative flex flex-col max-h-[95%] ${
