  ...
  <div className="text-xl flex items-center justify-between">
    <div className="flex items-center gap-2">
      ...
      >
        <path
          opacity="0.16"
          d="M4.16665 13.3333L3.33331 16.6667L6.66665 15.8333L15 7.5L12.5 5L4.16665 13.3333Z"
          fill="#C7C7C7"
        />
        <path
          d="M12.5 5L15 7.5M10.8333 16.6667H17.5M4.16665 13.3333L3.33331 16.6667L6.66665 15.8333L16.3216 6.17833C16.6341 5.86578 16.8096 5.44194 16.8096 5C16.8096 4.55806 16.6341 4.13421 16.3216 3.82166L16.1783 3.67833C15.8658 3.36588 15.4419 3.19035 15 3.19035C14.558 3.19035 14.1342 3.36588 13.8216 3.67833L4.16665 13.3333Z"
          stroke="#C7C7C7"
          strokeWidth="1.66667"
          strokeLinecap="round"
...
const Profilecreads = () => {
  ...
  const joinedAt = userData?.joinedAt || "Na";
  const datejoin = new Date(joinedAt);
    ...
    >
      <section className="w-full">
        ...
        <section className="flex w-full justify-between">
          <div
            className={`mt-5 w-1/2 flex gap-7 ${
          ...
          <div className="w-2/5 border rounded-xl p-3">
            ...
            <div className="mt-6 ml-3 flex flex-col gap-12">
              ...
              <div className="flex flex-col font-medium">
                Time Spent:
                <span className="ml-2 mt-2 font-light">
                  {totalAvailabilityHours} hrs
                </span>
              </div>
            </div>
          </div>
