        ...
        <div className="popup-overlay">
          <div
            className={`rounded-3xl shadow-lg ${
              isActivityLogOpen ? "w-[1359px]" : "w-[678px]"
            } overflow-y-auto pl-10 pr-10 p-4 relative flex flex-col max-h-[95%] ${
          ...
          >
            ...
            <div className="flex">
              ...
              <div
                className={`${
                  isActivityLogOpen ? "w-[678px]" : "w-full"
              ...
              {isActivityLogOpen && (
                <div className="w-[681px] pl-8  dark:border-gray-600">
                      ...
                      currentUser.editLogs.map((log, index) => (
                        <div key={log._id} className="relative pl-6 pb-8">
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex items-center gap-7 absolute mt-[35px] ml-[-100px]"></div>
                            <div className="flex items-center gap-7 absolute mt-[65px] ml-[-100px]"></div>
                          </div>
                        </div>
                      ))
                    ) : (
