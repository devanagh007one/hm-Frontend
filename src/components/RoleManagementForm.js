            ...
            <defs>
              ...
              >
                ...
                <feComposite
                  in2="SourceAlpha"
                  operator="in"
                  result="effect1_backgroundBlur_3004_846"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_backgroundBlur_3004_846"
                  result="shape"
                />
              </filter>
            </defs>
                        ...
                        >
                          {licensing.map((item) => (
                            <li
                              ...
                              onMouseDown={() =>
                                handleSelectChange(item.organisationName)
                              }
              ...
              <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col">
                  <label className=" mb-1">
                    Type of Content Specialization
                  </label>
                  <input
