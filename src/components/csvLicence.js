                    ...
                    Papa.parse(event.target.result, {
                        ...
                        complete: (result) => {
                            ...
                            const normalizedData = data.map((item) => {
                                ...
                                if (normalizedItem.active === "TRUE" || normalizedItem.active === "true" || normalizedItem.active === true) {
                                    normalizedItem.active = "TRUE";
                                } else if (normalizedItem.active === "FALSE" || normalizedItem.active === "false" || normalizedItem.active === false) {
                                    normalizedItem.active = "FALSE";
                                }
    
                                // Log the normalized active field value
                                console.log("Normalized active field value:", normalizedItem.active);
    ...
    const handleSendData = () => {
        ...
        const isValidData = (data) => {
            const requiredFields = [
                'organisationName', 'industryType', 'organizationSize', 'contactPersonName', 'contactPersonEmail',
                'address1', 'city', 'state', 'pinCode', 'phoneNumber', 'demoLicence', 'numberOfLicence', 'period', 'active'
            ];
