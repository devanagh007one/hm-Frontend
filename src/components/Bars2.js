...
const UserActivityChart = () => {
    ...
    return (
        <section className='gap-4 flex flex-col w-1/2'>
            <div title="User Activity" className={`card flex flex-col align-center p-4 pt-4 pb-4 justify-center w-full ${cardClass}`}>
                ...
                <ResponsiveContainer width="100%" height={200}>
                    <BarChart data={data}>
                        ...
                        <Tooltip />
                        {/* <Legend /> */}
                        <Bar dataKey="active" stackId="a" fill="#52c41a" stroke="none" barSize={5} />
                        <Bar dataKey="inactive" stackId="a" fill="#ff7875" stroke="none" barSize={5} />
                    </BarChart>
                </ResponsiveContainer>
                ...
                <div style={{ color: "#52c41a", fontSize: "16px", fontWeight: "bold", marginTop: 16 }}>
