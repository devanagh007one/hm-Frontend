    ...
    <>
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div
            className={`p-8 rounded-lg overflow-y-auto overflow-hidden shadow-lg w-[520px] h-[800px] max-h-[90%] ${
          ...
          >
            ...
            <form
              className="grid grid-cols-2 gap-6 w-full h-[97%] mt-3 pb-6"
                  ...
                  <Switch
                    onChange={(checked) =>
                      handleChange({
                        target: {
                          name: "period",
                          value: checked ? "Subscription" : "Trial",
                        },
                      })
                    }
                    checkedChildren="P"
